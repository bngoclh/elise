	...
	return (
		<SimpleGrid columns={{ base: 1, lg: 2 }} spacing={4}>
			<GridItem>
				...
				<FavoriteButton slug={slug} gameName={game.name} />

				<ExpandableText>{game.description_raw}</ExpandableText>
			{/* Cả phần Plateforms, Metascors,... ở dưới thuộc GameAttributes.tsx */}
				<GameAttributes game={game} />
			
			{/* Import CommentBox.tsx here */}
				<CommentBox game_id={game.id} game_slug={game.slug} />
			</GridItem>
